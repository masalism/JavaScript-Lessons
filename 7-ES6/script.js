...
question.set('question', 'What is the official name of the latest majpr JavaScript version?');
question.set(1, 'ES5');
question.set(2, 'ES6');
...
var john5 = new Person5('John', 1990, 'teatcher');
...
const john6 = new Person6('John', 1990, 'teatcher');
...
Athlete5.prototype.wonMedal1 = function() {
    this.medals++;
...
new Street('5th Street', 2015, 0.8), new Street('Sunset Boulevard', 2.5, 5)];
...
function reportStreets(s) {
    ...
    console.log(`Our ${s.length} streets have o total length of ${totalLength} km, with an average of ${avgLength} km.`);
